...
import { getWalletInfoForTx, blockchainProvider } from '../DoctorAction/c';
...
export async function mintNFT(
  ...
  try {
    ...
    const mintCompilecode = readValidator("mintdid.mint.mint");
    const storeCompilecode = readValidator("updatedid.store.spend");
