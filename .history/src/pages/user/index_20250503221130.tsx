...
import Image , {Static}from 'next/image';
...
const UserProfile: React.FC = () => {
  ...
  // User state
  const [userAvatar, setUserAvatar] = useState<string | StaticImageData>(defaultAvatar);
    ...
    const fetchUserData = async () => {
      if (wallet && connected) {
        try {
          ...
          // Fetch assets và chuyển đổi quantity về number
