...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Thêm logic thử nhiều cấu trúc formidable khác nhau
    let file;
    try {
      // Kiểm tra cấu trúc files phổ biến nhất
      ...
      // Kiểm tra cấu trúc khác nếu cách trên không hoạt động
      else if (formData.files) {
        // Lấy file đầu tiên từ bất kỳ field nào
      ...
      console.log('File object found:', file ? 'Yes' : 'No');
