...
const Hero: React.FC = () => {
  return (
    <section
      ...
      style={{
        background: `linear-gradient(90deg,rgba(10,20,40,0.45) 40%,rgba(10,20,40,0.75) 100%), url('https://png.pngtree.com/background/20210710/original/pngtree-simple-molecular-chain-medical-medical-poster-picture-image_1035651.jpg') center/cover no-repeat`,
        minHeight: '70vh',
        display: 'flex',
        alignItems: 'center',
        position: 'relative',
