    ...
    <div className={styles.container}>
      ...
      <header className={styles.header}>
        ...
        <nav className={styles.nav}>
          <ul>
            ...
            <li><a href="#features" className={styles.active}>Features</a></li>
      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <p>Sign up today to experience professional medical record management services</p>
          <div className={styles.heroButtons}>
            <button className={styles.getStartedNow}>Get Started Now</button>
      ...
      <footer className={styles.footer}>
        <div className={styles.copyright}>
          © 2025 MedRecord Pro. All rights reserved.
        </div>
