    ...
    <section className={styles.hero}>
      ...
      >
        ...
        >
          ...
          >
            Empowering Healthcare<br />with Secure Digital Records
          </h1>
          <p
            style={{
              fontSize: 20,
