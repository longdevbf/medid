...
const Hero: React.FC = () => {
  return (
    <section
      ...
      style={{
        background: `linear-gradient(rgba(10,20,40,0.60), rgba(10,20,40,0.70)), url('https://img4.thuthuatphanmem.vn/uploads/2021/01/10/hinh-anh-bac-si-kiem-tra-benh-an-dien-tu_021527623.jpg') center/cover no-repeat`,
        minHeight: '70vh',
        display: 'flex',
        alignItems: 'center',
        position: 'relative',
    ...
    >
      <div className={styles.container}>
        ...
        >
          ...
          >
            Modern healthcare meets technology: Manage, share, and protect your medical data with confidence. Our platform leverages blockchain to ensure privacy, transparency, and accessibility for every patient and provider.
          </p>
