...
const Hero: React.FC = () => {
  return (
    <section
      ...
      style={{
        background: `linear-gradient(90deg,rgba(10,20,40,0.45) 40%,rgba(10,20,40,0.75) 100%), url('https://img4.thuthuatphanmem.vn/uploads/2021/01/10/hinh-anh-bac-') center/cover no-repeat`,
        minHeight: '70vh',
        display: 'flex',
        alignItems: 'center',
        position: 'relative',
